...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editText = findViewById(R.id.packagenameinput);
        TextView requested_specific_output = findViewById(R.id.method1output);
        TextView granted_specific_output = findViewById(R.id.method2output);
